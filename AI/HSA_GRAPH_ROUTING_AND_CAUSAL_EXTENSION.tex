...
\subsection{Preliminary repeated-batch training runs}

Table~\ref{tab:preliminary-repeated-batch} shows longer repeated single-batch
resident training smokes on the real Gutenberg cache-backed batches. These are
still short internal training runs, not full downstream experiments, but they
are long enough to give a first indication of where the runtime crossover sits
and how the simple sliding baselines compare.

\begin{table}[ht]
\centering
\begin{tabular}{llrrr}
\toprule
$T$ & mode & final loss & mean dt (ms) & tok/s \\
\midrule
$65536$ & flat FA4 & $2.6773$ & $142.5$ & $460.0$k \\
$65536$ & sliding\_log & $2.1822$ & $57.7$ & $1135.2$k \\
$65536$ & sliding\_fixed & $2.6590$ & $60.0$ & $1091.6$k \\
$65536$ & HSA packed & $2.4808$ & $118.6$ & $552.8$k \\
\midrule
$131072$ & flat FA4 & $2.6736$ & $488.8$ & $268.1$k \\
$131072$ & sliding\_log & $2.5746$ & $291.5$ & $449.7$k \\
$131072$ & sliding\_fixed & $2.6528$ & $138.8$ & $944.2$k \\
$131072$ & HSA packed & $2.5972$ & $252.3$ & $519.5$k \\
\midrule
$262144$ & flat FA4 & $2.9803$ & $1734.7$ & $151.1$k \\
$262144$ & sliding\_log & $2.9657$ & $359.5$ & $729.3$k \\
$262144$ & sliding\_fixed & $2.9793$ & $367.3$ & $713.7$k \\
$262144$ & HSA packed & $2.9611$ & $344.3$ & $761.5$k \\
\bottomrule
\end{tabular}
\caption{Preliminary repeated-batch resident training runs on real Gutenberg
cache-backed batches. These are useful internal smokes for runtime crossover and
loss trend, but they are not yet the full long-horizon training report.}
\label{tab:preliminary-repeated-batch}
\end{table}

Several points matter immediately.
\begin{enumerate}[leftmargin=1.5em]
    \item The packed HSA path has already crossed the flat dense FA4 baseline
    on throughput by $64$K and remains ahead at $128$K.
    ...
    \item On these short repeated-batch runs, \texttt{sliding\_log} is
...
The $262144$ row is the first regime where the packed HSA path cleanly clears
both the dense flat baseline and the simple sliding baselines on this repeated
single-batch smoke. That does not prove a general downstream quality win by
itself, but it is exactly the systems crossover the packing story was supposed
to produce.
