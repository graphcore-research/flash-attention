...
from flash_attn.cute.cute_dsl_utils_qkfast import assume_tensor_aligned
...
from flash_attn.cute.pack_gqa import PackGQA as PackGQABase, pack_gqa_layout, pack_gqa_layout_seqmajor
from flash_attn.cute import mma_sm100_desc as sm100_desc
from flash_attn.cute import blackwell_helpers_qkfast as sm100_utils
...
class PackGQAQKFast(PackGQABase):
...
# Preserve the historical type name used in annotations below.
PackGQA = PackGQABase
...
class FP4FlashAttentionForwardSm100:
    ...
    def mma(
        ...
        if const_expr(self.use_fp4_qk):
            ...
            mma_kind = "mxf4nvf4" if self.fp4_sf_vec_size == 16 else "mxf4"
            gemm_Si = [
                partial(
